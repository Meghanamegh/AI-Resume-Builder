       ...
       {fields.map((field)=>{
           ...
           return (
            <div key={field.key} className='space-y-1 mt-5'>
                ...
                className="mt-1 w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-md 
                focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 
                text-sm text-gray-800 placeholder:text-gray-400 transition-shadow shadow-sm" placeholder={`Enter your ${field.label.
